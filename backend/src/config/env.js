...
export const env = {
  ...
  frontendOrigins: parseOrigins(process.env.FRONTEND_URL || 'http://localhost:5173'),
  frontendUrl: parseOrigins(process.env.FRONTEND_URL || 'http://localhost:5173')[0] || 'http://localhost:5173',
